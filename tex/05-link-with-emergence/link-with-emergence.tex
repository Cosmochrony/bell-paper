\section{Discussion and Conceptual Positioning}
  ...
  existence of a set of accessible variables that fully determine observable outcomes.
  ...
  The present approach is also distinct from superdeterministic models.
  ...
  Measurement choices remain free and uncorrelated with the underlying configuration
  space.
  ...
  Non-injective projection provides such a condition, clarifying how quantum
  correlations can arise without abandoning locality at the underlying level.

  In this sense, Bell inequality violations may be viewed not as evidence for exotic
  dynamics, but as indicators of intrinsic limitations of effective descriptions.
