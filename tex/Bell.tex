...
\begin{document}
  ...
  \section{Non-Injective Projection and the Failure of Bell Factorization}
    ...
    \subsection{Quantitative bounds from projection entropy}
      ...
      the singlet correlator $E(\hat{a}, \hat{b}) = -\hat{a} \cdot \hat{b}$ is derived as an
      unconditional structural consequence of the SU(2) geometry of the admissible fibre,
