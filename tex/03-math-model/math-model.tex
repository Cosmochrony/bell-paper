\section{Bell Inequalities Revisited: Structural vs Dynamical Assumptions}
  ...
  higher-dimensional relational configuration space onto a lower-dimensional
  description.
  In particular, configuration spaces with $S^3$ topology together with Hopf-type
  projections onto effective observables provide a natural geometric realization of
  this mechanism, where the loss of injectivity is controlled by projective
  invariants associated with the fiber structure.
